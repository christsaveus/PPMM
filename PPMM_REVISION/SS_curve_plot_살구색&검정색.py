...
# Define a custom colormap from adjusted light red to black
colors = [adjust_brightness((1, 0.49, 0.49), 1.5), adjust_brightness((0, 0, 0), 1.5)]  # Adjusted Light Red -> Adjusted Black
...
plt.savefig('brightened_plot.png', dpi=450)
plt.show()
